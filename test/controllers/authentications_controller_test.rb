...
class AuthenticationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post authentications_url, params: { authentication: { name: @authentication.name, password_digest: @authentication.password_digest, username: @authentication.username } }
    end
  ...
  test "should update authentication" do
    patch authentication_url(@authentication), params: { authentication: { name: @authentication.name, password_digest: @authentication.password_digest, username: @authentication.username } }
